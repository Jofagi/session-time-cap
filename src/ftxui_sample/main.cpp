...
// configuration step. It creates a namespace called `session_time_cap`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", session_time_cap::cmake::project_name, session_time_cap::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", session_time_cap::cmake::project_version);
      return EXIT_SUCCESS;
    }
